...
<form class="container" bind:this={form} on:submit={handleSubmit}>
  ...
  <select id="project" name="projectId" disabled={projects.length == 1} required bind:value={projectId}>
...
{#if loading || success || error}
  <div class="overlay">
      {#if loading == true}
        ...
        <div class="loading-text"> <p><i> Images are uploading; please wait... </i></p></div>
