...
<main class="flex flex-col items-center w-full">
    <div class="flex flex-col items-center w-full">
        ...
        <div class="p-4 pb-0 w-full">
            <div
                class="toolbar p-3 rounded-xl flex flex-wrap justify-between gap-2 w-full bg-gray-200 border border-solid border-gray-400"
            >
                <button
        ...
        <div class="px-4 w-full">
            <div
                class="bg-gray-200 border border-gray-400 rounded-xl grid grid-cols-3 px-2 w-full shadow-lg"
            >
                <button
                    class="rounded-lg my-2 p-3 px-4 transition-all {view ==
                    Views.FullReport
                        ? 'bg-gray-300'
                        : 'cursor-pointer'}"
                    onclick={() => (view = Views.FullReport)}
                ...
                <button
                    ...
                    Views.PDF
                        ? 'bg-gray-300'
                        : 'cursor-pointer'}"
                    onclick={() => (view = Views.PDF)}>View PDF</button
                >
                <button
                    class="rounded-lg my-2 p-3 px-4 transition-all {view ==
                    Views.Images
                        ? 'bg-gray-300'
                        : 'cursor-pointer'}"
                    onclick={() => (view = Views.Images)}>View Images</button
                >
            </div>
        </div>
        {#if view == Views.FullReport}
            ...
            <div class="p-4">
                <!-- Toolbar 2 -->
                <div
                    class="toolbar bg-gray-200 border border-solid border-gray-400 p-3 rounded-xl flex flex-wrap justify-between gap-2 w-full mb-4"
                >
                    <button
                ...
                <div
                    class="w-full relative bg-gray-200 border border-solid border-gray-400 overflow-hidden"
                >
                    <div
                        class="overflow-y-auto w-full max-h-[65vh] md:max-h-[80vh] flex justify-center bg-gray-50"
                    >
                        <div
                            class="whitespace-pre-wrap break-words p-4 py-8 md:p-[1in] flex flex-col"
                            class:justify-center={!report}
                        >
                            {#if report}
                                <h4
                                    class="text-xl md:text-2xl text-center mb-2 md:mb-4"
                                >
                                    {data.project.title}
                                </h4>
                                <h5
                                    class="text-base md:text-lg text-center mb-4 md:mb-8"
                                >
                                    {data.student?.name}
                                </h5>
                            ...
                            {:else}
                                ...
                                >
                                    <span class="text-4xl w-full text-center"
                                        >No text report has been uploaded for
                                        this project.</span
                                    >
        ...
        {:else if view == Views.PDF}
            <div class="p-4 w-full">
                <div
                    class="images bg-gray-200 border border-solid border-gray-400 rounded-xl grid grid-rows-[auto_minmax(0,_1fr)] w-full"
                >
                    <div
                        class="p-8 py-4 text-xl bg-gray-300 shadow-md rounded-t-xl flex justify-between items-center"
                    >
                    ...
                    <div class="p-4">
                        {#if data.project.pdfUrl}
                            <iframe
                                ...
                                class="w-full h-[65vh] border border-gray-300 rounded bg-white"
                            ></iframe>
                        {:else}
                            <div
                                class="flex items-center justify-center min-h-[16rem] text-gray-600"
                            >
        ...
        {:else if view == Views.Images}
            ...
            <div class="p-4 w-full">
                ...
                >
                    ...
                    <div
                        class="overflow-y-auto max-h-[65vh] w-full h-full min-h-[24rem]"
                    >
                        <div class="flex flex-col px-4 h-full">
                            ...
                            {:else}
                                <div
                                    class="flex items-center justify-center col-span-full h-full"
                                >
