        ...
        <div class="flex items-center gap-12">
            <div class="flex flex-col items-start gap-4">
                <div class="flex gap-2 items-start flex-col">
                    ...
                    <span contenteditable="plaintext-only" class="text-base rounded-md bg-gray-200 p-2 border-gray-400 border min-w-72" bind:innerHTML={project.title}>{data.project.title}</span>
                </div>
                ...
                <div class="flex gap-2 items-start flex-col">
                    ...
                    <span contenteditable="plaintext-only" class="text-base rounded-md bg-gray-200 p-2 border-gray-400 border min-w-72 max-w-[32rem]" bind:innerHTML={project.shortDesc}>{data.project.shortDesc}</span>
                </div>
            </div>
            <div class="flex flex-col items-start gap-2 p-8">
                <h2 class="text-lg">Mentor</h2>
                <div class="flex flex-col items-start bg-gray-200 rounded-xl p-4">
