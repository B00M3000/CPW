...
const schema = new mongoose.Schema(
  {
    ...
    sessionId: { type: String, index: { unique: true, partialFilterExpression: { sessionId: { $type: 'string' } } } },
    googleId: { type: String, index: { unique: true, partialFilterExpression: { sessionId: { $type: 'string' } } } },
